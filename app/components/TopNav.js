...
export default function TopNav() {
	...
	return (
		<div
			id="TopNav"
			className="fixed bg-gradient-to-r from-pink-500 via-pink to-red-500 shadow-xl z-30 flex items-center w-full border-black h-[60px]"
		>
			<div className="flex items-center justify-between w-full gap-6 px-10 mx-auto">
				{/* For You Button (Left side) */}
				<div className="flex items-center">
					<Link href="/">
						<p className="text-white font-bold text-2xl mr-4">LingLingLing</p>
					</Link>
					{pathName === "/upload" ? (
